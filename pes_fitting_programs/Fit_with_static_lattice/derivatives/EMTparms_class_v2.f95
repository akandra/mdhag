...
subroutine emt_r_init (a_lat, cell_0, r0_lat, n_l0, pars_p, pars_l, E_dref, dE_ref)
!subroutine emt_fit (cell, a_lat, n_l, r_lat, r_part, pars_p, pars_l, energy, denergy_l, denergy_p)
!
! Purpose:
! ========
...
!-----------------------DECLARE VARIABLES FOR DERIVATIVES----------------------
    ...
    real(8), dimension(1,n_l0) :: dsigma_ll
    real(8), dimension(1) :: dV_ll
    real(8), dimension(1,n_l0) :: ds_l_l_ref
    real(8), dimension(1) :: dvref_l_l_ref
    real(8), dimension(1) :: dEcoh_ref
    real(8) :: chilp                    ! mixing between lattice (l) and particle (p)
