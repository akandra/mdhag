...
!    integer                         :: n_l          ! number of reference lattice atoms
...
subroutine old_emt_init (a_lat, cell_0, n_l0, r0_lat_in, pars_p, pars_l, energy)
!subroutine emt_init (cell_in, n_l_in, r0_lat_in, pars_p, pars_l, energy)
!
! Purpose:
!           Here, the fitting procedure is just implemented and the reference
...
end subroutine old_emt_init

subroutine old_emt_fit_init (a_lat, cell_0, r0_lat, n_l0, pars_p, pars_l, E_dref, dE_ref)
!subroutine emt_fit (cell, a_lat, n_l, r_lat, r_part, pars_p, pars_l, energy, denergy_l, denergy_p)
!
! Purpose:
! ========
...
end subroutine old_emt_fit_init
