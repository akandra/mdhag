...
!    integer :: n_l ! number of gold atoms in extended slab
    ...
    call open_for_write(134,'data/parameters_and_fit_results/rms_F272_372_385.dat')
...
!    lattice_nml_out   = 'data/parameters_and_fit_results/stroem_der.268.Au.nml'
    ...
    particle_nml_in = 'data/parameters_and_fit_results/stroem_der.439.H.nml' !stroem.00.H.nml'
    lattice_nml_in  = 'data/parameters_and_fit_results/stroem_der.439.Au.nml' !stroem.00.Au.nml'
!    particle_nml_in = 'data/parameters_and_fit_results/stroem_der.'//kk//'.H.nml' !stroem.00.H.nml'
!    lattice_nml_in  = 'data/parameters_and_fit_results/stroem_der.'//kk//'.Au.nml' !stroem.00.Au.nml'
